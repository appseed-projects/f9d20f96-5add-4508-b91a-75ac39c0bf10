...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-17 10:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f9d20f96-5add-4508-b91a-75ac39c0bf10.git
$ cd f9d20f96-5add-4508-b91a-75ac39c0bf10
```
